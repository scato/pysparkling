...
from pysparkling.sql.column import Column, _to_seq, _to_java_column, _create_column_from_literal
...
def _test():
    ...
    import pysparkling.sql.group
    globs = pysparkling.sql.group.__dict__.copy()
    ...
    (failure_count, test_count) = doctest.testmod(
        pysparkling.sql.group, globs=globs,
