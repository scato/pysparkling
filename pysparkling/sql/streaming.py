...
from pysparkling import since, keyword_only
from pysparkling.rdd import ignore_unicode_prefix
from pysparkling.sql.column import _to_seq
from pysparkling.sql.readwriter import OptionUtils, to_str
...
def _test():
    ...
    import os
    import tempfile
    from pysparkling.sql import Row, SparkSession, SQLContext
    import pysparkling.sql.streaming

    os.chdir(os.environ["SPARK_HOME"])

    globs = pysparkling.sql.streaming.__dict__.copy()
    try:
        spark = SparkSession.builder.getOrCreate()
    ...
    (failure_count, test_count) = doctest.testmod(
        pysparkling.sql.streaming, globs=globs,
