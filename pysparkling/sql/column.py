...
class Column(object):
    ...
    def when(self, condition, value):
        ...
        See :func:`pysparkling.sql.functions.when` for example usage.
    ...
    def over(self, window):
        ...
        """
        from pysparkling.sql.window import WindowSpec
...
def _test():
    import doctest
    from pysparkling.sql import SparkSession
    import pysparkling.sql.column
    globs = pysparkling.sql.column.__dict__.copy()
    ...
    (failure_count, test_count) = doctest.testmod(
        pysparkling.sql.column, globs=globs,
