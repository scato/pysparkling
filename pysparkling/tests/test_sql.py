...
"""
Unit tests for pysparkling.sql; additional tests are implemented as doctests in
individual modules.
"""
import os
import sys
...
from pysparkling import SparkContext
from pysparkling.sql import SparkSession, SQLContext, HiveContext, Column, Row
from pysparkling.sql.types import *
from pysparkling.sql.types import UserDefinedType, _infer_type, _make_type_verifier
from pysparkling.sql.types import _array_signed_int_typecode_ctype_mappings, _array_type_mappings
from pysparkling.sql.types import _array_unsigned_int_typecode_ctype_mappings
from pysparkling.tests import QuietTest, ReusedPySparkTestCase, SparkSubmitTests
from pysparkling.sql.functions import UserDefinedFunction, sha2, lit
from pysparkling.sql.window import Window
from pysparkling.sql.utils import AnalysisException, ParseException, IllegalArgumentException
...
class SQLTests(ReusedPySparkTestCase):
    ...
    def tearDown(self):
        ...
        self.spark.sql("DROP TABLE IF EXISTS pysparkling_bucket")
    ...
    def test_explode(self):
        from pysparkling.sql.functions import explode, explode_outer, posexplode_outer
        d = [
    ...
    def test_udf_in_filter_on_top_of_outer_join(self):
        from pysparkling.sql.functions import udf
    ...
    def test_udf_with_filter_function(self):
        ...
        from pysparkling.sql.functions import udf, col
        from pysparkling.sql.types import BooleanType
    ...
    def test_udf_with_aggregate_function(self):
        df = self.spark.createDataFrame([(1, "1"), (2, "2"), (1, "2"), (1, "2")], ["key", "value"])
        from pysparkling.sql.functions import udf, col, sum
        from pysparkling.sql.types import BooleanType
    ...
    def test_udf_in_generate(self):
        from pysparkling.sql.functions import udf, explode
    ...
    def test_udf_with_input_file_name(self):
        from pysparkling.sql.functions import udf, input_file_name
    ...
    def test_udf_defers_judf_initalization(self):
        ...
        from pysparkling.sql.functions import UserDefinedFunction
    ...
    def test_udf_with_decorator(self):
        from pysparkling.sql.functions import lit, udf
        from pysparkling.sql.types import IntegerType, DoubleType
    ...
    def test_udf_wrapper(self):
        from pysparkling.sql.functions import udf
        from pysparkling.sql.types import IntegerType
    ...
    def test_validate_column_types(self):
        from pysparkling.sql.functions import udf, to_json
        from pysparkling.sql.column import _to_java_column
    ...
    def test_udt(self):
        from pysparkling.sql.types import _parse_datatype_json_string, _infer_type, _make_type_verifier
        from pysparkling.sql.tests import ExamplePointUDT, ExamplePoint
    ...
    def test_infer_schema_with_udt(self):
        from pysparkling.sql.tests import ExamplePoint, ExamplePointUDT
    ...
    def test_string_functions(self):
        from pysparkling.sql.functions import col, lit
    ...
    def test_array_contains_function(self):
        from pysparkling.sql.functions import array_contains
    ...
    def test_parse_datatype_string(self):
        from pysparkling.sql.types import _all_atomic_types, _parse_datatype_string
    ...
    def test_stream_status_and_progress(self):
        ...
        from pysparkling.sql.functions import col, udf
        sleep_udf = udf(func)
    ...
    def test_stream_exception(self):
        ...
        from pysparkling.sql.functions import col, udf
        from pysparkling.sql.utils import StreamingQueryException
    ...
    def test_time_with_timezone(self):
        ...
        from pysparkling.sql.tests import UTCOffsetTimezone
    ...
    def test_functions_broadcast(self):
        from pysparkling.sql.functions import broadcast
    ...
    def test_generic_hints(self):
        from pysparkling.sql import DataFrame
    ...
    def test_list_tables(self):
        from pysparkling.sql.catalog import Table
        spark = self.spark
        spark.catalog._reset()
        spark.sql("CREATE DATABASE some_db")
    ...
    def test_list_functions(self):
        from pysparkling.sql.catalog import Function
        spark = self.spark
        spark.catalog._reset()
        spark.sql("CREATE DATABASE some_db")
    ...
    def test_list_columns(self):
        from pysparkling.sql.catalog import Column
        spark = self.spark
        spark.catalog._reset()
        spark.sql("CREATE DATABASE some_db")
        spark.sql("CREATE TABLE tab1 (name STRING, age INT) USING parquet")
    ...
    def test_bucketed_write(self):
        ...
        def count_bucketed_cols(names, table="pysparkling_bucket"):
        ...
        df.write.bucketBy(3, "x").mode("overwrite").saveAsTable("pysparkling_bucket")
        self.assertEqual(count_bucketed_cols(["x"]), 1)
        self.assertSetEqual(set(data), set(self.spark.table("pysparkling_bucket").collect()))

        # Test write two bucketing columns
        df.write.bucketBy(3, "x", "y").mode("overwrite").saveAsTable("pysparkling_bucket")
        self.assertEqual(count_bucketed_cols(["x", "y"]), 2)
        self.assertSetEqual(set(data), set(self.spark.table("pysparkling_bucket").collect()))

        # Test write with bucket and sort
        df.write.bucketBy(2, "x").sortBy("z").mode("overwrite").saveAsTable("pysparkling_bucket")
        self.assertEqual(count_bucketed_cols(["x"]), 1)
        self.assertSetEqual(set(data), set(self.spark.table("pysparkling_bucket").collect()))
        ...
        (df.write.bucketBy(2, "x")
            .sortBy(["y", "z"])
            .mode("overwrite").saveAsTable("pysparkling_bucket"))
        self.assertSetEqual(set(data), set(self.spark.table("pysparkling_bucket").collect()))
...
class HiveSparkSubmitTests(SparkSubmitTests):
    ...
    def test_hivecontext(self):
        ...
        script = self.createTempFile("test.py", """
            ...
            |from pysparkling.sql import HiveContext
            |
            |conf = SparkConf()
...
class HiveContextSQLTests(ReusedPySparkTestCase):
    ...
    def test_unbounded_frames(self):
        ...
        from pysparkling.sql import functions as F
        from pysparkling.sql import window
        import importlib
...
class VectorizedUDFTests(ReusedPySparkTestCase):
    ...
    def test_vectorized_udf_basic(self):
        from pysparkling.sql.functions import pandas_udf, col
    ...
    def test_vectorized_udf_zero_parameter(self):
        from pysparkling.sql.functions import pandas_udf
    ...
    def test_vectorized_udf_complex(self):
        from pysparkling.sql.functions import pandas_udf, col, expr
        df = self.spark.range(10).select(
    ...
    def test_vectorized_udf_mix_udf(self):
        from pysparkling.sql.functions import pandas_udf, udf, col
        df = self.spark.range(10)
...
if __name__ == "__main__":
    from pysparkling.sql.tests import *
    if xmlrunner:
