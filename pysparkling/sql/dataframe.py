...
from pysparkling import copy_func, since
from pysparkling.rdd import RDD, _load_from_socket, ignore_unicode_prefix
from pysparkling.serializers import ArrowSerializer, BatchedSerializer, PickleSerializer, \
    UTF8Deserializer
from pysparkling.storagelevel import StorageLevel
from pysparkling.traceback_utils import SCCallSiteSync
from pysparkling.sql.types import _parse_datatype_json_string
from pysparkling.sql.column import Column, _to_seq, _to_list, _to_java_column
from pysparkling.sql.readwriter import DataFrameWriter
from pysparkling.sql.streaming import DataStreamWriter
from pysparkling.sql.types import IntegralType
...
class DataFrame(object):
    ...
    @since(1.3)
    def rdd(self):
        """Returns the content as an :class:`pysparkling.RDD` of :class:`Row`.
        """
    ...
    @since(1.3)
    def schema(self):
        """Returns the schema of this :class:`DataFrame` as a :class:`pysparkling.sql.types.StructType`.
    ...
    def alias(self, alias):
        ...
        >>> from pysparkling.sql.functions import *
...
def _test():
    ...
    from pysparkling.sql import Row, SQLContext, SparkSession
    import pysparkling.sql.dataframe
    from pysparkling.sql.functions import from_unixtime
    globs = pysparkling.sql.dataframe.__dict__.copy()
    ...
    (failure_count, test_count) = doctest.testmod(
        pysparkling.sql.dataframe, globs=globs,
