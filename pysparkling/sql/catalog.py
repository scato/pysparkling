...
from pysparkling.sql.types import IntegerType, StringType, StructType
...
def _test():
    ...
    import pysparkling.sql.catalog

    os.chdir(os.environ["SPARK_HOME"])

    globs = pysparkling.sql.catalog.__dict__.copy()
