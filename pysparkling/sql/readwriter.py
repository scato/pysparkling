...
from pysparkling import RDD, since, keyword_only
from pysparkling.rdd import ignore_unicode_prefix
from pysparkling.sql.column import _to_seq
from pysparkling.sql.types import *
from pysparkling.sql import utils
...
class DataFrameReader(OptionUtils):
    ...
    def schema(self, schema):
        ...
        :param schema: a :class:`pysparkling.sql.types.StructType` object or a DDL-formatted string
    ...
    def load(self, path=None, format=None, schema=None, **options):
        ...
        :param schema: optional :class:`pysparkling.sql.types.StructType` for the input schema
    ...
    def json(self, path, schema=None, primitivesAsString=None, prefersDecimal=None,
        ...
        :param schema: an optional :class:`pysparkling.sql.types.StructType` for the input schema or
    ...
    def csv(self, path, schema=None, sep=None, encoding=None, quote=None, escape=None,
        ...
        :param schema: an optional :class:`pysparkling.sql.types.StructType` for the input schema
                       or a DDL-formatted string (For example ``col0 INT, col1 DOUBLE``).
...
class DataFrameWriter(OptionUtils):
    ...
    def _sq(self, jsq):
        from pysparkling.sql.streaming import StreamingQuery
...
def _test():
    ...
    from pysparkling.sql import SparkSession, Row
    import pysparkling.sql.readwriter

    os.chdir(os.environ["SPARK_HOME"])

    globs = pysparkling.sql.readwriter.__dict__.copy()
    ...
    (failure_count, test_count) = doctest.testmod(
        pysparkling.sql.readwriter, globs=globs,
